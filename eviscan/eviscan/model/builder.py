...
import torch
from eviscan.eviscan.model import *
from eviscan.eviscan.constants import DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
from eviscan.eviscan.utils import rank0_print
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", attn_implementation="flash_attention_2", customized_config=None, overwrite_config=None, **kwargs):
    ...
    if "llava" in model_name.lower()  or "eviscan" in model_name.lower() or is_multimodal:
        # Load LLaVA model
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            if "mixtral" in model_name.lower():
                from eviscan.eviscan.model.language_model.llava_mixtral import LlavaMixtralConfig
                ...
                from eviscan.eviscan.model.language_model.llava_mistral import LlavaMistralConfig
                ...
                from eviscan.eviscan.model.language_model.llava_gemma import LlavaGemmaConfig
                ...
                from eviscan.eviscan.model.language_model.llava_llama import LlavaConfig
            ...
            if "mixtral" in model_name.lower():
                ...
                from eviscan.eviscan.model.language_model.llava_qwen import LlavaQwenConfig
    ...
    if "llava" in model_name.lower() or "eviscan" in model_name.lower() or is_multimodal:
        ...
        # model.resize_token_embeddings(len(tokenizer)) # NOTE: qin change self.config.vocab_size+1 to len(tokenizer)
